...
//管理員使用區
    ...
    //取得所有留言資料
    router.get('/getAllMessage', verifyCookie, allowRoles('admin'),messageController.getAllMessage);

    //取得今日所有留言資料
    router.get('/getToDayMessage', verifyCookie, allowRoles('admin'),messageController.getToDayMessage);
